...
{
    /// <summary>
    /// Represents a processed parsed JSON request.
    /// </summary>
    [Table("RequestJsonParsedProcessed")]
    public class RequestJsonParsedProcessed
    {
        /// <summary>
        /// Gets or sets the primary key for the processed parsed JSON request.
        /// </summary>
        [Key]
        ...
        /// <summary>
        /// Gets or sets the row ID of the processed parsed JSON.
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// Gets or sets the path of the processed parsed JSON.
        /// </summary>
        [Required]
        [MaxLength(500)]
        ...
        /// <summary>
        /// Gets or sets the key of the processed parsed JSON.
        /// </summary>
        [Required]
        [MaxLength(200)]
        ...
        /// <summary>
        /// Gets or sets the value of the processed parsed JSON.
        /// </summary>
