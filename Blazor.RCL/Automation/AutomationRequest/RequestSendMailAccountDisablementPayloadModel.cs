...
{
    /// <summary>
    /// Represents the payload model for sending an account disablement mail request.
    /// </summary>
    public class RequestSendMailAccountDisablementPayloadModel : IRequestPayloadModel
    {
        /// <summary>
