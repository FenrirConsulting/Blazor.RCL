...
{
    /// <summary>
    /// Represents a demo task associated with a request.
    /// </summary>
    [Table("RequestTask_Demo")]
    public class RequestTask_Demo
    {
        /// <summary>
        /// Gets or sets the primary key for the request task demo.
        /// </summary>
        [Key]
        ...
        /// <summary>
        /// Gets or sets the returned request task primary key.
        /// </summary>
        public int? RequestTaskPK_Returned { get; set; }

        /// <summary>
        /// Gets or sets the batch execution ID.
        /// </summary>
        public string? BatchExecutionId { get; set; }

        /// <summary>
        /// Gets or sets the starting thread ID.
        /// </summary>
        public string? StartingThreadId { get; set; }

        /// <summary>
        /// Gets or sets the ending thread ID.
        /// </summary>
        public string? EndingThreadId { get; set; }
