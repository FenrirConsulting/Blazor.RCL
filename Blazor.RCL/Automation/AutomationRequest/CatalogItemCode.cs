...
{
    /// <summary>
    /// Represents a catalog item code.
    /// </summary>
    [Table("CatalogItemCode")]
    public class CatalogItemCode
    {
        /// <summary>
        /// Gets or sets the primary key for the catalog item code.
        /// </summary>
        [Key]
        public short CatalogItemCodePK { get; set; }
        ...
        [Required]
        [MaxLength(100)]
        public string CatalogItemDesc { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets a value indicating whether the catalog item code is active.
        /// </summary>
