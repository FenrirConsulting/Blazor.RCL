...
{
    /// <summary>
    /// Represents status codes for tasks.
    /// </summary>
    [Table("TaskStatusCode")]
    public class TaskStatusCode
    {
        /// <summary>
        /// Gets or sets the primary key for the task status code.
        /// </summary>
        [Key]
        public short TaskStatusCodePK { get; set; }

        /// <summary>
        /// Gets or sets the description of the task status.
        /// </summary>
        [Required]
        [MaxLength(100)]
        public string TaskStatusDesc { get; set; } = string.Empty;
