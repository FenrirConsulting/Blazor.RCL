...
{
    /// <summary>
    /// Represents an execution status code in the Automation batch processing system.
    /// </summary>
    [Table("ExecutionStatusCode")]
    public class ExecutionStatusCode
    {
        #region Properties

        /// <summary>
        /// Gets or sets the unique identifier for the execution status code.
        /// </summary>
        [Key]
        public short ExecutionStatusCodePK { get; set; }

        /// <summary>
        /// Gets or sets the execution status description.
        /// </summary>
        [Required]
        [MaxLength(100)]
